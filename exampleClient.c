...
int main() {
    ...
    uint8_t msg2[] = {0x09, 0x00, 0x76, 0x60, 0x68, 0x65, 0x6C, 0x6C, 0x6F, 0x00, 0xCF, 0x6C};
    ...
    //     uint8_t msg2[] = {0x09, 0xA8, 0x00, 0x05, 0x68, 0x65, 0x6C, 0x6C, 0x6F, 0x00, 0xB2, 0x80};
    // }else if(messageCount == 3){
    //     printf("Sending RHMP Message of type: Message_Request\n");
    //     uint8_t msg3[] = {0x12, 0xE8, 0x30, 0x41, 0x31, 0x20, 0x76, 0x18, 0x15, 0x9E};
    // }else{
    //     printf("Sending RHMP Message of type: ID_Request\n");
    //     uint8_t msg4[] = {0x12, 0xE8, 0x30, 0x41, 0x31, 0x20, 0x76, 0x18, 0x15, 0x9E};
    // }
